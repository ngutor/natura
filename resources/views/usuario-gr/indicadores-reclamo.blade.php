...
<html lang="es">
<head>
    <title>Indicadores - Gestión de Reclamos</title>
    @include("common.head")
    <style type="text/css">
                        ...
                        <div class="fluid-list filter-b" id="filterS">
                            <ul class="reset-ul">
                                ...
                                <li>
                                    ...
                                    <input id="tbGerencia" name="grn[]" name="grn[]" type="hidden" value="{{ $user->v_PerClienteAgrupa1 }}" />
                                    <input id="tbSector" name="str[]" name="str[]" type="hidden" value="{{ $user->v_PerClienteAgrupa2 }}" >
                                </li>
                                <li>
