        	...
        	<header class="header fluid-list">
        		...
        		<div class="fluid-list nav-header">
        			<ul class="reset-ul">
                        ...
                        <li><a href="{{ url('auditoria') }}" class="{{ $idx == 2 ? 'active' : '' }}">Auditoría</a></li>
                        <li><a href="{{ url('reclamos') }}" class="{{ $idx == 3 ? 'active' : '' }}">Reclamos</a></li>
        				<li class="dropdown">
                        ...
                        <li><a href="{{ url('usuarios') }}" class="{{ $idx == 5 ? 'active' : '' }}">Administración de Usuarios</a></li>
        			</ul>
        		</div>
                    ...
                    <div>
                        ...
                        <div class="fluid-list cnt-list-menu-d">
                            <ul class="reset-ul">
                                ...
                                <li>
                                    <a href="{{ url('auditoria') }}" class="{{ $idx == 2 ? 'active' : '' }}">Auditoría</a>
                                </li>
                                <li>
                                    <a href="{{ url('reclamos') }}" class="{{ $idx == 3 ? 'active' : '' }}">Reclamos</a>
                                </li>
                                <li>
