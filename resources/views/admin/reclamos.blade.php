...
<body class="drawer drawer--right">
        ...
        <div class="container">
            ...
            <div class="fluid-list cnt-container">
                ...
                <div class="fluid-list cnt-table-filter cnt-table-reclamos">
                    ...
                    <div class="fluid-list cnt-m-reclamos">
                        <ul class="reset-ul">
                            <li>
                                <a href="#" data-toggle="modal" data-target="#modal-upload" class="sReclamos"><i class="fa fa-upload" aria-hidden="true"></i> Subir Reclamos</a>
                            </li>
                            <li>
                                <a href="javascript:descargaReclamo()" class="dReclamos"><i class="fa fa-download" aria-hidden="true"></i> Descargar Reclamos</a>
                            </li>
                            <!--li>
                                <a href="#" class="sSoluciones"><i class="fa fa-flag-o" aria-hidden="true"></i> Subir Soluciones</a>
                            </li-->
                        </ul>
                    </div>
                    <!--No considerar este bloque en el desarrollo>
                    <div class="fluid-list" style="background: #ccc;">
                        <p>Esta lista es para mostrar los modals de eventos, no considerar en el desarrollo.</p>
                        <ul class="reset-ul">
                            <li style="float:left;margin-right: 10px;"><a href="#" data-toggle="modal" data-target="#tModalSubio">Subio Archivo</a></li>
                            <li style="float:left;margin-right: 10px;"><a href="#" data-toggle="modal" data-target="#tModalDescargo">Descargo Archivo</a></li>
                            <li style="float:left;margin-right: 10px;"><a href="#" data-toggle="modal" data-target="#tModalNoSubio">No subio archivo</a></li>
                            <li style="float:left;margin-right: 10px;"><a href="#" data-toggle="modal" data-target="#tModalNoDescargo">No descargo archivo</a></li>
                        </ul>
                    </div>
                    <End-->
                    <form id="form-xls" action="{{ url('export/reclamos') }}" method="post">
                        <div class="fluid-list filter-b" id="filterS">
                            <ul class="reset-ul">
                                ...
                                <!--li>
                                    <select id="adFecha" name="dts[]" class="form-control" multiple="multiple">
                                        <option value="1">12/03/2017</option>
                                        <option value="2">12/03/2017</option>
                                        <option value="3">12/03/2017</option>
                                        <option value="4">12/03/2017</option>
                                        <option value="5">12/03/2017</option>
                                    </select>
                                </li-->
                                <li>
                                    <input type="text" id="gvCodCons" name="gvCodCons" name="ccn" class="form-control gvCod adCconsulta" placeholder="Ingresa código.">
                                </li>
                                <li>
    ...
    <!--Modal subio archivo-->
    <div class="modal fade modal-custom-alert" id="tModalSubio" tabindex="-1" role="dialog" aria-labelledby="tModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body center">
                    <div class="fluid-list">
                        <img src="{{ asset('asset/img/ico-upload.png') }}">
                    </div>
                    <p>El archivo se subió correctamente.</p>
                    <div class="fluid-list">
                        <button type="button" class="btn btn-mC btn-cancelar" data-dismiss="modal">CERRAR</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade modal-custom-alert" id="tModalDescargo" tabindex="-1" role="dialog" aria-labelledby="tModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body center">
                    <div class="fluid-list">
                    ...
                    <p>El archivo se descargó correctamente.</p>
                    <div class="fluid-list">
                        <button type="button" class="btn btn-mC btn-cancelar" data-dismiss="modal">CERRAR</button>
                    </div>
                </div>
    ...
    <!--End-->
    <!--Modal no subio archivo-->
    <div class="modal fade modal-custom-alert" id="tModalNoSubio" tabindex="-1" role="dialog" aria-labelledby="tModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body center">
                    <div class="fluid-list">
                        <img src="{{ asset('asset/img/ico-no-s.png') }}">
                    </div>
                    <p>Lo sentimos. El archivo no se pudo subir.</p>
                    <div class="fluid-list">
                        <button type="button" class="btn btn-mC btn-cancelar" data-dismiss="modal">CERRAR</button>
                    </div>
                </div>
    ...
    <!--End-->
    <!--Modal no descargar archivo-->
    <div class="modal fade modal-custom-alert" id="tModalNoDescargo" tabindex="-1" role="dialog" aria-labelledby="tModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body center">
                    <div class="fluid-list">
                    ...
                    <p>Lo sentimos. El archivo no se pudo descargar.</p>
                    <div class="fluid-list">
                        <button type="button" class="btn btn-mC btn-cancelar" data-dismiss="modal">CERRAR</button>
                    </div>
                </div>
    ...
    <!--End-->
    <!--Modal de upload-->
    <div class="modal fade modal-custom-n" id="modal-upload" tabindex="-1" role="dialog" aria-labelledby="modalUploadLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal m-form-n" id="form-upload">
                        <h2>Subir reclamos</h2>
                        <div class="form-group">
                            <label for="in-reclamo" class="col-sm-2 control-label">Archivo:</label>
                            <div class="col-sm-10">
                                <input id="in-reclamo" class="form-control" type="file" name="xls" />
                            </div>
                        </div>
                        <div class="form-group">
                            <p><br/><br/></p>
    ...
    <form id="form-download" action="{{ url('export/descarga') }}" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
    </form>
    <!-- -->
    ...
    <script type="text/javascript">
        ...
        function descargaIndividual() {
            var td = $(this).parent();
            var tr = td.parent();
            document.getElementById("autogenatc").value = tr.data("agnatc");
            document.getElementById("rautogen").value = tr.data("autogen");
            document.getElementById("rnroproceso").value = tr.data("nrproc");
            document.getElementById("rnrocontrol").value = tr.data("nrcont");
            document.getElementById("ciclo").value = td.prev().prev().prev().prev().prev().prev().prev().prev().html();
            document.getElementById("fecha").value = td.prev().prev().prev().prev().prev().prev().prev().html();
            document.getElementById("eini").value = td.prev().prev().prev().html();
            document.getElementById("efin").value = td.prev().prev().html();
            document.getElementById("form-single-download").submit();
        }
                    ...
                    for(var i in data) {
                        ...
                        $("#tableCN-body").append(
                            $("<tr/>").data({ autogen: fila.agn, nrproc: fila.npr, nrcont: fila.nct, idx:i, load:"N", agnatc: fila.autoatc }).append(
                                ...
                                $("<td/>").addClass("center").append(
                                    $("<a/>").attr("href","javascript:void(0)").append(
                                        $("<span/>").addClass("glyphicon glyphicon-download-alt").attr("aria-hidden","true")
                                    ).on("click",descargaIndividual)
                                )
